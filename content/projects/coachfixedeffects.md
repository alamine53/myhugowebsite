...
Brad Stevens is considered one of the league's most promising coaches. So far, he's had a win percentage of 56 percent, below Jackson's but an applaudable accomplishment nonetheless (he does not yet have any championships to speak of). Stevens' resume becomes considerably more impressive when you consider the quality of the roster, especially early in his career. In 2017, for exampke, he took a roster led by Isaiah Thomas and Jae Crowder to the top of the Eastern Conference. Those same players --- and others like Bradley, Olynyk, and Baynes --- haven't had nearly the kind of success on any other team before or after their term on the Celtics. Clearly then, there is something specific about Stevens that elevated their performance. 	 

Some coaches may benefit from particularly strong talent, while others may overperform with lesser rosters. Neither of those cases are captured by win records. There needs to be a more systematic way of assessing coaching ability.
...
My approach relies on what economists call **fixed effects**. Applied to NBA coaches, fixed effects capture the impact of head coach identity on team wins, while controlling for roster quality and injuries. Since a good portion of NBA coaches are observed on more than one team, this allows to trace their impact across different rosters. The resulting estimate is a measure of a contribution to team wins in a given season relative to the mean head coach. For more details on the methodology, see [how fixed effects are calculated](#how-fixed-effects-are-calculated). For the full list of resulting estimates, skip to [the end of this article](#full-metrics).
