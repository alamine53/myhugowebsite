...
*I apply the concept of regression discontinuity to estimate the value of playoff experience in the NBA. I find that, on average, teams who barely make the playoffs gain 8 percent additional wins next season relative to those who barely miss it. These results vary given by sample size.*
...
You probably already know, otherwise this article wouldn't have existed. But guess what? The data says that 8th seeds are much more likely to improve in the following season than 9th seeds. Brilliant. 
...
Even with little chance of going all the way, the battle of the 8th seed is very much worth fighting for. A trip to the playoffs, even a quick one, provides significant return on investment.
